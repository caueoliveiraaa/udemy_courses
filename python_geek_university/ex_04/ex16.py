...
polegadas = float(input('Digite o valor do comprimento em polegadas: '))
convertido_cm = polegadas * 2.54


print('O valor do comprimento convertido para centímetros é:', convertido_cm)
