...
hc = float(input('Digite o valor da área em hectares: '))
convertido_metros_quad = hc * 10000
print(f'O valor da área convertida para metros quadrados é: {convertido_metros_quad}')