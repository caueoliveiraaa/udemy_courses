...
acres = float(input('Digite o valor de área em acres: '))
convertido_metros_quad = acres * 4048.58


print('O valor de área convertido para metros quadrados é: {convertido_metros_quad}')
